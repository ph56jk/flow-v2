...
3. Open each browser profile and complete Google sign-in.
   Đăng nhập ở địa chỉ **không có** đoạn `/vi/`: bản có locale giờ là
   trang giới thiệu, còn phiên đăng nhập mà app đọc token nằm ở
   `labs.google/fx/tools/flow/project/<id>`. (đo ngày 08/09/2026)
...
powershell -ExecutionPolicy Bypass -File .\scripts\login_flow_profile.ps1 `
  ...
  -ProjectUrl "https://labs.google/fx/tools/flow/project/your-project-id" `
