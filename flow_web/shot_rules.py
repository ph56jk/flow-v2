...
PRODUCT_SHOT_RULES: Dict[str, Dict[str, Any]] = {'tooth_fairy_pillow': {'display_name': 'Tooth Fairy Pillow',
 ...
 'ornament_round': {'display_name': 'Ornament Round',
                    'aliases': ('Ornament_Round',
                                ...
                                'ornament giang sinh',
                                # Thêm tay (hvg-pc), không có trong workbook: tên bảng
                                # thật trên ERP viết tiếng Việt. Sinh lại file này từ
                                # Excel là mất — nhớ chép lại.
                                'xmas ornament',
                                'ornament thêu tròn',
                                'ornament theu tron'),
                    'target_count': 12,
 ...
 'bride_handkerchief': {'display_name': 'Bride Handkerchief',
                        'aliases': ('Bride Handkerchief',
                                    ...
                                    'khăn tay cô dâu',
                                    'khan tay co dau'),
                        # Tên board thật của xưởng không nói "cô dâu": PROJ-0013 tên là
                        # "XMAS Khăn Tay Thêu Tay". Chữ này phải đứng liền nhau mới tính
                        # (alias_phrases, xem _flow_operator_product_rule_key_from_text).
                        'alias_phrases': ('khăn tay thêu', 'khan tay theu'),
